...
<html>
<head>
	<!-- build date: Mon, 27 Jun 2016 02:54:25 GMT -->
	<title>Format numeric zip code, left aligned | The ASP.NET Forums</title>
...
<meta name="description" content="wwwVixen I have incoming values like: 70471 704710823 but i want to format them as such: 70471 70471-0823 You can try using String.Insert method to add a hypen after 5 numbers You can try with the..." />
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@aspnet" />
<meta name="twitter:domain" content="forums.asp.net" />
<meta name="twitter:image:src" content="//forums-asp.azureedge.net/resources/v-2016-06-24-004/cheetah/style/images/ui/asplogo-square.png" />
<meta name="twitter:title" content="Re: Format numeric zip code, left aligned" />
<meta name="twitter:description" content="wwwVixen I have incoming values like: 70471 704710823 but i want to format them as such: 70471 70471-0823 You can try using String.Insert method to add a hypen after 5 numbers You can try with the..." />
<meta property="og:type" content="website" />
<meta property="og:title" content="Re: Format numeric zip code, left aligned" />
<meta property="og:description" content="wwwVixen I have incoming values like: 70471 704710823 but i want to format them as such: 70471 70471-0823 You can try using String.Insert method to add a hypen after 5 numbers You can try with the..." />
<meta property="og:image" content="//forums-asp.azureedge.net/resources/v-2016-06-24-004/cheetah/style/images/ui/asplogo-square.png" />
<meta property="og:url" content="http://forums.asp.net/post/6027065.aspx" />
...
<meta property="fb:admins" content="robmcm" />
    ...
    <link rel="canonical" href="http://forums.asp.net/t/2086827.aspx?Format+numeric+zip+code+left+aligned" />

    <link rel="search" type="application/opensearchdescription+xml" title="Forums.asp.net" href="/opensearch.xml">
	<link href="//forums-asp.azureedge.net/resources/v-2016-06-24-004/favicon.ico" rel="shortcut icon" />    
    
	
		<link href="//forums-asp.azureedge.net/resources/v-2016-06-24-004/cheetah/style/css-bundle/common-responsive.css" rel="stylesheet" type="text/css" media="all" />
	
    
		
	
	<!--[if lte IE 9]>
      <script src='//forums-asp.azureedge.net/resources/v-2016-06-24-004/scripts/html5.js' type="text/javascript"></script>
    <![endif]-->
    <script type="text/javascript" src="//forums-asp.azureedge.net/resources/v-2016-06-24-004/scripts/jquery-1.8.3.min.js"></script>
...
<body class="details single">	

	

    <div class="all-content">
	    <!--Edit me from backoffice - Raw - Banner-->
<!--<div style="background-color:#fc0;padding:10px;font-size:16px;text-align:center;"><a href="http://aspnet.uservoice.com/forums/350103-forums-asp-net-website">Help us improve the ASP.NET Forums! We want to hear your ideas</a>!</div>-->
		<header>
 ...
 <div class="nav-user logged-out">
	...
	<div class="common-dropdown collapse">
		<a href="//forums.asp.net/login/RedirectToLogin?ReturnUrl=%2fpost%2f6027065.aspx">Sign in</a>
        <a href="//forums.asp.net/login/RedirectToCreateUser?ReturnUrl=%2fpost%2f6027065.aspx">Join</a>
	</div>
</div>
		...
		<nav class="clearfix nav-main">
			<div>
				...
				<ul>
					...
					<li class="nav-getstarted"><a href="javascript:;">Get Started</a><div class="common-dropdown collapse">
	<div class="col">
	  <ul>
		<li><a href="//www.asp.net/get-started" data-s-object-id="learn">ASP.NET</a></li>
		<li><a href="https://docs.asp.net/en/latest/getting-started.html" data-s-object-id="learn">ASP.NET Core</a></li>
	  </ul>
	</div>
  </div></li>
					<li class="nav-learn"><a href="javascript:;">Learn</a><div class="common-dropdown collapse">
	<div class="col">
	  <ul>
		<li><a href="//www.asp.net/aspnet" data-s-object-id="learn">ASP.NET</a>
		<li><a href="http://docs.asp.net/" data-s-object-id="learn">ASP.NET Core</a></li>
	  </ul>
	</div>
</div>
	...
	<div class="col">
	  <h2>More</h2>
		<ul>
                         ...
                         <li><a href="//www.asp.net/vnext" data-s-object-id="learn">ASP.NET Core (RC2)</a></li>
						 </ul>
	</div>
  </div>
--></li>
					<li><a href="//hosting.asp.net/hosting">Hosting</a></li>
					<li><a href="//www.asp.net/downloads">Downloads</a></li>
					<li class="nav-community"><a href="javascript:;">Community</a><div class="common-dropdown collapse">
			<div class="col">
				<ul>
...
<div class="header-breadcrumb-content">
    <a href="//www.asp.net" title="Home">Home</a><span>/</span><a href="//forums.asp.net" title='ASP.NET Forums'>ASP.NET Forums</a><span>/</span><a href="/default.aspx/1?+NET+Languages" title=".NET Languages">.NET Languages</a><span>/</span><a href="/37.aspx/1?C+" title="C#">C#</a><span>/</span><a href="/t/2086827.aspx?Format+numeric+zip+code+left+aligned" title="Format numeric zip code, left aligned">Format numeric zip code, left aligned</a><span>/</span><a href="/p/2086827/6027065.aspx?Re+Format+numeric+zip+code+left+aligned" title="Re: Format numeric zip code, left aligned">Re: Format numeric zip code, left aligned</a>
</div>

    <div class="content-wrapper" id="content-wrapper">
        <div class="wrapper-ad">

<div id="FeaturedAd_8" data-adtypeid="5" data-adzoneid="0" class="add-space advertise-square clearfix" style="margin-bottom: 30px;width:300px;height:250px;"></div></div>
        <div class="pagination-thread first"> <a class="common-btn" href="/t/2086827.aspx">View Complete Thread</a>  </div>
        <div class="clear"></div>
...
<div class="module-nav-container">
	<div class="module-nav nav-base">
		<h2>Shortcuts</h2>
		<ul>
			<li><a href="/f/active/37/1/20">Active Threads</a></li>
			<li><a href="/f/unanswered/37/1/20">Unanswered Threads</a></li>
			<li><a href="/f/unresolved/37/1/20">Unresolved Threads</a></li>
...
<li class="comment-wrap  answered " data-postid="6027065" title="">
    <ul class="comment-nav">                    
        
                <li><a href="/login/RedirectToLogin?ReturnUrl=/post/set/37/2086827/6027065">Reply</a></li>
            
    </ul>
    <div class="comment-left-col">
        
<a title="a2h" href="/members/a2h.aspx"><img class="post-thumb" src="/avatar/a2h.jpg?forceidenticon=False&dt=636032149800000000" alt="a2h" title="a2h"/></a>

<h3 class="post-title"><a title="a2h" href="/members/a2h.aspx">a2h</a></h3>

<p class="post-level">All-Star</p>
<div class="post-rating All-Star" title="43663 Points"></div>
<p class="post-points">43663 Points</p>

<p class="post-count"><a href="/search?q=authors%3A%28a2h%29&amp;s=postDate&amp;d=desc">8141 Posts</a></p>

    </div>
    <div class="comment-right-col">                      
        <a name="6027065"></a>      
        <h3>Re: Format numeric zip code, left aligned</h3>
        <p class="date">Mar 02, 2016 03:43 PM<span class="print-only-inline"><span class="separator">&#124;</span>a2h</span><span class="print-no responsive-no"><span class="separator">&#124;</span><a href="/post/6027065.aspx" title="Permalink to this post">LINK</a></span>
        <div>
<blockquote>
<h4>wwwVixen</h4>
<p>I have incoming values like:</p>
<p><strong>70471</strong><br>
<strong>704710823</strong></p>
<p>but i want to format them as such:</p>
<p><strong>70471</strong><br>
<strong>70471-0823</strong></p>
</blockquote>
<p>You can try using&nbsp;<a href="http://msdn.microsoft.com/en-us/library/system.string.insert%28v=VS.71%29.aspx" rel="nofollow">String.Insert</a><span>&nbsp;method to add a hypen after 5 numbers</span></p>
<p>You can try with the below code</p>
<pre class="prettyprint ">string yourvalue = &quot;704710823&quot;;
                string finalresult = &quot;&quot;;
                ////Check if string length is greater than 5
                if (yourvalue.Length &gt; 5)
                {
                    //If so then add a hypen after 5 numbers
                    finalresult = yourvalue.Insert(5, &quot;-&quot;);
                }
                else
                {
                    //otherwise return the number
                    finalresult = yourvalue;
                }</pre>
<ul>
<li><strong><a href="https://dotnetfiddle.net/8DKra1" title="123" target="_blank">Sample Demo</a></strong>
</li></ul>
</div>		
        ...
        <div class="comment-signiture">
            Thanks,<br/>A2H<br/><a href="http://aspdotnetcodehelp.wordpress.com" rel="nofollow">My Blog</a>
        </div>
        ...
        <form id="__AjaxAntiForgeryForm" action="#" method="post"><input name="__RequestVerificationToken" type="hidden" value="HPsUPT1NPv0ri3gY3bnAj4ar8eYflnhuM8z2OFnIQuniGrROT6T3vyrBAc4W6HaPqZc9Fdg4GGp6qpRqIP4X4Kf88581" /></form>
...
<li class="block">
<h2>This site is managed for Microsoft by Neudesic, LLC. | &copy; 2016 Microsoft. All rights reserved.</h2>
</li>
...
<li><a href="//www.asp.net/support">Support Lifecycle</a></li>
    ...
    <script type="text/javascript">var searchDomain = "//www.asp.net";</script>
	<script type="text/javascript" src="//forums-asp.azureedge.net/resources/v-2016-06-24-004/scripts/scripts-bundle/cheetah-main.js"></script>
    
    
	 

<script type="text/javascript" src="//forums-asp.azureedge.net/resources/v-2016-06-24-004/scripts/scripts-bundle/prettify.js"></script>
<script type="text/javascript">
	...
	<script type="text/javascript">if ((Math.floor(Math.random() * 100)) < 5) { $.getScript('/v-2016-06-24-004/resources/scripts/scripts-bundle/survey.js'); }</script>
	...
	<script src="https://www.microsoft.com/library/svy/asp/broker.js" defer="defer"></script>
    <script type='text/javascript' src='//pixel.mathtag.com/event/js?mt_id=1007149&mt_adid=162962&v1=&v2=&v3=&s1=&s2=&s3=' defer="defer"></script>
