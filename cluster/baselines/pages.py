...
class allPages:
    def __init__(self, folder_path, dataset, date="Mar15", mode="read",num_samples=None): # mode: {raw, read, write}
    ...
    def Evaluation(self,min_r,min_epsilon):
        ...
        train_batch_file = open("./results/{}_train_baseline.results".format(self.dataset),"a")
        prefix =  str(self.dataset)
        train_batch_file.write(prefix + "\tmin_r:{0}\tmin_epsilon:{1}\n".format(min_r,min_epsilon))
